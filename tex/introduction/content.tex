...
In summary, helping an aging societies to deal with labor shortage,
...
a nuanced understanding of trajectory
...
trajectory generation: (a) \ac{mpc} which formulates
trajectory generation as an optimization problem which is
solved in a receding horizon fashion and (b) \ac{fabrics}
where trajectory generation is formulated as a 
...
\begin{enumerate}
    \item Enable real-time capable \ac{mpc} formulations for
      coupled trajectory generation in mobile manipulators
...
manipulation and trajectory generation, offering novel
...
\begin{figure}
  \begin{center}
    \input{introduction/img/drawing.pdf_tex}
  \end{center}
