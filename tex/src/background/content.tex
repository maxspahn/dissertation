...
\section{Trajectory Generation} % (fold)
...
goal state. Importantly, the goal state might be defined in a
...
% section trajectory_generation (end)

\section{Dynamic Environments} % (fold)
...
\begin{figure}[ht]
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \includegraphics[width=\textwidth]{robot_in_hospital.png}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.45\textwidth}
    \includegraphics[width=\textwidth]{human_shared_environment.png}
  \end{subfigure}
...
for the next solution. This process is usually referred to as
...
summarized: the definitions of conservative fabrics and
energization are introduced.
...
Afterwards, we formalized a vanilla \ac{mpc} formulation for
