...
known a priori. That means that goal configurations, such as
...
are supermarkets, hospitals, or homes. \MS{Add figure}
...
framework.
When using optimization fabrics for motion generation, all
