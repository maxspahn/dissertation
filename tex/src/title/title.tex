...
born in Bergisch Gladbasch, Germany.
...
\begin{center}
    ...
    \hspace{2em}
    \includegraphics[height=0.5in]{logos/casimir} \\
    \includegraphics[height=0.5in]{logos/fom}
    \hspace{2em}
    \includegraphics[height=0.5in]{logos/nwo}
\end{center}
\vfill
