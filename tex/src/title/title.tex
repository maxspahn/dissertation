...
\textit{Wednesday} the \textit{11th} of \textit{December}
\textit{2024}, at \textit{17:30}
...
\begin{tabular}{l l}
    ...
    \textit{Front \& Back:} & Max Spahn using Geometric
    Fabrics and Matplotlib\\
    & Code for visuals available at \\
    & \url{https://github.com/maxspahn/visuals_fabrics} \\[\medskipamount]
\end{tabular}
