...
the application of \ac{mpc} to a mobile manipulator.
...
%mobile manipulators has been hindered by the curse of dimensionality.
This
chapter introduces an implicit environment representation for \ac{mpc},
