\begin{abstract}
The implementation of \acf{mpc} demonstrated its capability to
...
optimization-based methods towards a geometric approach known as \acf{fabrics}.
...
Moreover, extensive comparisons between \ac{mpc} and \acf{sf} are conducted to
