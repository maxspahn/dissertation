...
global North. In the process, we identify trajectory
...
\begin{enumerate}
  ...
  \item \MS{Potentially add contribution of environment
    representations.}
\end{enumerate}
