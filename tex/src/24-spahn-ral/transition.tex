...
on simplistic environment representations, usally composed of primitive shapes.
...
to relax the requirements on the perception pipeline. We quantatively compare
