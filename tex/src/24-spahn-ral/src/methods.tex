...
Having introduced optimization \ac{fabrics} in the previous section, this sections
introduces numerical gradients in the framework and proposes three different
implicit environment representations. Then, we propose methods to integrate
these representations into the framework of optimization \ac{fabrics}.

\MS{Still need to explain how capsules are integrated.}
...
Collision avoidance in the context of optimization \ac{fabrics} is based on
