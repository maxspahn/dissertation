...
\ac{fabrics} detailed in \cite{Spahn2023}. Future endeavors should concentrate
...
delving into dynamic environmental representations, an exploration of the potential
synergies between the implicit representations introduced here and the findings
from \cite{Spahn2023} is a promising avenue for investigation.
