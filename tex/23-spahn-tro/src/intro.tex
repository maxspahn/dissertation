...
the guaranteed collision avoidance and thus safety~\cite{Hrovat2012,Hewing2020}.
...
reduced generalization abilities, loss of formal guarantees~\cite{Hewing2020}
...
predecessors, such as RMP~\cite{Cheng2018} and RMP-Flow~\changed{\cite{Cheng2020}},
...
\begin{enumerate}
  \item We enable the usage of optimization fabrics for dynamic scenarios.
    ...
    \changed{, see \cref{fig:reference_trajectory}}.
